...
{
    public partial class frm_sale_mpl : Form
    {
        OleDbConnection con = new OleDbConnection();
        string u;

        public frm_sale_mpl(string user)
        {
            InitializeComponent();
...
Persist Security Info=False;";
        ...
        private void frm_sale_mpl_Load(object sender, EventArgs e)
        {
            this.BackgroundImage = Image.FromFile(@"D:\2nd semester\OOPs\Prison_Project_Data\backgrond\39.jpg");
        ...
        private void btn_sale_dsp_Click(object sender, EventArgs e)
        {
            frm_sale_dsp f1 = new frm_sale_dsp(u,false);
            f1.Show();
            this.Hide();
        }
        ...
        private void btn_search_Click(object sender, EventArgs e)
        {
            ...
            cmd.Connection = con;
            cmd.CommandText = "Select * from PURCHASE_SALE_INFO where I_ID='" + text + "' and Type = 'Sale'";
        ...
        private void btn_add_Click(object sender, EventArgs e)
        {
            ...
            OleDbCommand cmd = new OleDbCommand();
            cmd.Connection = con;
            cmd.CommandText = "Insert into PURCHASE_SALE_INFO ([I_ID], [B_ID], [I_Name], [Price], [Quantity], [T_Amount], [Month], [Type]) values ('" + txt_I_id.Text + "','" + txt_B_ID.Text + "','" + txt_i_name.Text + "','" + txt_i_price.Text + "','" + txt_i_qty.Text + "','" + txt_i_t_amt.Text + "','" + cmb_i_month.Text + "','Sale')";
            cmd.ExecuteNonQuery();
        ...
        private void btn_update_Click(object sender, EventArgs e)
        {
            ...
            OleDbCommand cmd = new OleDbCommand();
            cmd.Connection = con;
            string query = "Update PURCHASE_SALE_INFO set [B_ID]='" + txt_B_ID.Text + "',[I_Name]='" + txt_i_name.Text + "',[Price]='" + txt_i_price.Text + "',[Quantity]='" + txt_i_qty.Text + "',[T_Amount]='" + txt_i_t_amt.Text + "',[Month]='" + cmb_i_month.Text + "',[Type]='Sale' where [I_ID]='" + txt_I_id.Text + "'";
