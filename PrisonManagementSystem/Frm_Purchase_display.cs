...
{
    public partial class frm_purchase_dsp : Form
    {
        OleDbConnection con = new OleDbConnection();
        string u;
        bool c;
        int count;
        public frm_purchase_dsp(string user, bool check)
        {
            InitializeComponent();
...
Persist Security Info=False;";
        ...
        private void frm_purchase_dsp_Load(object sender, EventArgs e)
        {
            this.BackgroundImage = Image.FromFile(@"D:\2nd semester\OOPs\Prison_Project_Data\backgrond\38.jpg");
            ...
            com.Connection = con;
            string query = "Select I_ID,B_ID,I_Name,Price,Quantity,T_Amount,Month from PURCHASE_SALE_INFO where Type= 'Purchase' ";
            com.CommandText = query;
            OleDbDataAdapter adap = new OleDbDataAdapter(com);
            DataTable dt = new DataTable();
            adap.Fill(dt);
            dgv_purchase.DataSource = dt;
        ...
        private void btn_back_Click(object sender, EventArgs e)
        {
            ...
            {
                frm_purchase_mpl f1 = new frm_purchase_mpl(u);
                f1.Show();
                this.Hide();
            }
        }
        ...
        private void btn_first_Click(object sender, EventArgs e)
        {
            ...
            if (count > 0)
            {
                ...
                dgv_purchase.Rows[count].Selected = true;
            }
            else
            {
                if (count == 0)
        ...
        private void btn_search_Click(object sender, EventArgs e)
        {
            ...
            for (int rowno = 0; rowno < dgv_purchase.Rows.Count-1; rowno++)
            {
                if (txt_search.Text == dgv_purchase.Rows[rowno].Cells[0].Value.ToString())
                {
                    dgv_purchase.ClearSelection();
                    dgv_purchase.Rows[rowno].Selected = true;
                }
        ...
        private void tableDocument_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            OleDbCommand com = new OleDbCommand();
            com.Connection = con;
            string query = "Select * from PURCHASE_SALE_INFO where Type= 'Purchase'";
            com.CommandText = query;
            OleDbDataAdapter adap = new OleDbDataAdapter(com);
            DataSet d = new DataSet();
            adap.Fill(d, "PURCHASE_SALE_INFO");
