...
{
    public partial class frm_spr_Log : Form
    {
...
Persist Security Info=False;"; 
        ...
        {
            this.BackgroundImage = Image.FromFile(@"D:\2nd semester\OOPs\Prison_Project_Data\backgrond\17.jpg");
        ...
        private void btn_login_Click(object sender, EventArgs e)
        {
            ...
            if (count == 1)
            {
                ...
                frm_spr_Block f2 = new frm_spr_Block();
                f2.Show();
                con.Dispose();
                this.Hide();
            }
